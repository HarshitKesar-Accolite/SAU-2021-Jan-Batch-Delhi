...
public class CalculatorServiceLocator extends org.apache.axis.client.Service implements com.harshit.assignment.CalculatorService {
    ...
    private java.lang.String Calculator_address = "http://localhost:8080/SOAPAssignment/services/Calculator";
    ...
    public com.harshit.assignment.Calculator getCalculator(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.harshit.assignment.CalculatorSoapBindingStub _stub = new com.harshit.assignment.CalculatorSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.harshit.assignment.Calculator.class.isAssignableFrom(serviceEndpointInterface)) {
                com.harshit.assignment.CalculatorSoapBindingStub _stub = new com.harshit.assignment.CalculatorSoapBindingStub(new java.net.URL(Calculator_address), this);
                _stub.setPortName(getCalculatorWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://assignment.harshit.com", "CalculatorService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://assignment.harshit.com", "Calculator"));
        }
